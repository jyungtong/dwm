...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:size=10", "Noto Color Emoji:size=12" };
...
static const char *selectsshot[]  = { "maim -s | xclip -selection clipboard -t image/png", NULL };
